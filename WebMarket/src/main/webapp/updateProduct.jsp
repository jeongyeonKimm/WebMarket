...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7">
				<form name="newProduct" action="./processUpdateProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-date">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="file" name="productIage" class="form-control">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-offset-2 col-sm-10">
							<input type="submit" class="stn snt--primary" value="등록">
						</div>
					</div>
				</form>
			</div>
